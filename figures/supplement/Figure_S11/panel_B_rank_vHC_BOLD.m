...
% Jonathan Reinwald
%
% Standalone repository script for Supplementary Figure S11B.
%
% Supplementary Figure S11B relates social rank to mean vHC BOLD values extracted from
% the corresponding rank-related vHC cluster.
%
...
% │
% └── results/supplement/Figure_S11/Figure_S11B/
%
% -------------------------------------------------------------------------
...
% repository/figures/supplement/Figure_S11/panel_B_rank_vHC_BOLD.m
...
fprintf('\nSupplementary Figure S11B input check\n');
fprintf('Animals: %d\n', nAnimals);
...
fig = figure( ...
    'Name', ...
    'Supplementary Figure S11B: Rank vs vHC BOLD', ...
    'Visible', ...
    'on', ...
    'Color', ...
    'white', ...
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'SourceData_Figure_S11B_Rank_vHC_BOLD.csv' ...
    ) ...
);
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'Statistics_Figure_S11B_Rank_vHC_BOLD.csv' ...
    ) ...
);
...
save( ...
    fullfile( ...
        outputDir, ...
        'Results_Figure_S11B_Rank_vHC_BOLD.mat' ...
    ), ...
    'result' ...
);
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'AnalysisMetadata_Figure_S11B.csv' ...
    ) ...
);
...
fprintf('Supplementary Figure S11B completed.\n');
