% panel_A_rank_vHC_BOLD.m
% Jonathan Reinwald
%
% Standalone repository script for Supplementary Figure S11A.
%
% Supplementary Figure S11A relates social rank to mean vHC BOLD values extracted from
...
% │
% └── results/supplement/Figure_S11/Figure_S11A/
%
% -------------------------------------------------------------------------
...
% repository/figures/supplement/Figure_S11/panel_A_rank_vHC_BOLD.m
...
fprintf('\nSupplementary Figure S11A input check\n');
fprintf('Animals: %d\n', nAnimals);
...
fig = figure( ...
    'Name', ...
    'Supplementary Figure S11A: Rank vs vHC BOLD', ...
    'Visible', ...
    'on', ...
    'Color', ...
    'white', ...
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'SourceData_Figure_S11A_Rank_vHC_BOLD.csv' ...
    ) ...
);
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'Statistics_Figure_S11A_Rank_vHC_BOLD.csv' ...
    ) ...
);
...
save( ...
    fullfile( ...
        outputDir, ...
        'Results_Figure_S11A_Rank_vHC_BOLD.mat' ...
    ), ...
    'result' ...
);
...
writetable( ...
    ...
    fullfile( ...
        outputDir, ...
        'AnalysisMetadata_Figure_S11A.csv' ...
    ) ...
);
...
fprintf('Supplementary Figure S11A completed.\n');
