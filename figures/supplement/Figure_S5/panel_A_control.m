...
outputDir = fullfile( ...
    repoRoot,'results','supplement','Figure_S5','Figure_S5A','control' ...
);
...
exportgraphics(figPre, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_PRE_11to40.pdf'), ...
    'ContentType','vector','BackgroundColor','white');

exportgraphics(figPre, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_PRE_11to40.png'), ...
    'Resolution',300,'BackgroundColor','white');

exportgraphics(figTest, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_81to120.pdf'), ...
    'ContentType','vector','BackgroundColor','white');

exportgraphics(figTest, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_81to120.png'), ...
    'Resolution',300,'BackgroundColor','white');

writeLabeledMatrix( ...
    fullfile(outputDir,'SourceData_Figure_S5A_control_Odor_PRE_11to40.csv'), ...
    meanPre,roiNames);

writeLabeledMatrix( ...
    fullfile(outputDir,'SourceData_Figure_S5A_control_Odor_TEST_81to120.csv'), ...
    meanTest,roiNames);
...
exportgraphics(figComparison, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_vs_PRE_PairedTMatrix.pdf'), ...
    'ContentType','vector','BackgroundColor','white');

exportgraphics(figComparison, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_vs_PRE_PairedTMatrix.png'), ...
    'Resolution',300,'BackgroundColor','white');
...
exportgraphics(figSchemaball, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_vs_PRE_Schemaball.pdf'), ...
    'ContentType','vector','BackgroundColor','white');

exportgraphics(figSchemaball, ...
    fullfile(outputDir,'Figure_S5A_control_Odor_TEST_vs_PRE_Schemaball.png'), ...
    'Resolution',300,'BackgroundColor','white');

%% Source/statistics

filePrefix = 'Figure_S5A_control_Odor_TEST_vs_PRE';
...
writetable(metadata, ...
    fullfile(outputDir,'AnalysisMetadata_Figure_S5A_control_Odor.csv'));
