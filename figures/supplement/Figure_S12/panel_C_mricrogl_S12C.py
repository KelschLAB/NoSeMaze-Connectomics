# panel_C_mricrogl.py
#
# MRIcroGL script for Supplementary Figure 12C.
#
# Displays the activation map on the high-resolution
...
# │   └── activation*T01.nii
# │
# └── results/supplement/Figure_S12/Figure_S12C/
#
...
if not os.path.isdir(input_dir):
    raise FileNotFoundError(
        'Supplementary Figure 12C input directory not found:\n' + input_dir
    )
...
# Mosaic matched to Figure S12A/S12B
