% panel_A_conditioning_TMatrix.m
% Jonathan Reinwald
%
...
%
% Output:
%   results/supplement/Figure_S4/Figure_S4A/
%
% -------------------------------------------------------------------------
...
comparisonTitle = sprintf( ...
    'Figure_S4A: %s TPnoPuff TEST > PRE', ...
    cohortName ...
);
...
filePrefix = 'Figure_S4A_conditioning_TPnoPuff_TEST_vs_PRE';
