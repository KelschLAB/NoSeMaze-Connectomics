...
outputDir = fullfile( ...
    repoRoot,'results','main','Figure_3','Figure_3A','conditioning' ...
);
...
for analysisIndex = 1:numel(analysisTypes)
    ...
    exportgraphics( ...
        ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_PRE_11to40.pdf',analysisName)), ...
    ...
    exportgraphics( ...
        figPre, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_PRE_11to40.png',analysisName)), ...
        'Resolution',300,'BackgroundColor','white' ...
    );

    writeLabeledMatrix( ...
        fullfile(outputDir,sprintf( ...
            'SourceData_Figure3_conditioning_%s_PRE_11to40.csv', ...
            analysisName)), ...
        meanPre,roiNames ...
    );
    ...
    exportgraphics( ...
        figTest, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_81to120.pdf',analysisName)), ...
        'ContentType','vector','BackgroundColor','white' ...
    );
    ...
    exportgraphics( ...
        figTest, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_81to120.png',analysisName)), ...
        'Resolution',300,'BackgroundColor','white' ...
    );

    writeLabeledMatrix( ...
        fullfile(outputDir,sprintf( ...
            'SourceData_Figure3_conditioning_%s_TEST_81to120.csv', ...
            analysisName)), ...
        meanTest,roiNames ...
    );
    ...
    exportgraphics( ...
        figComparison, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_vs_PRE_PairedTMatrix.pdf', ...
            analysisName)), ...
        'ContentType','vector','BackgroundColor','white' ...
    );
    ...
    exportgraphics( ...
        figComparison, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_vs_PRE_PairedTMatrix.png', ...
            analysisName)), ...
        'Resolution',300,'BackgroundColor','white' ...
    );
    ...
    exportgraphics( ...
        figSchemaball, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_vs_PRE_Schemaball.pdf', ...
            analysisName)), ...
        'ContentType','vector','BackgroundColor','white' ...
    );
    ...
    exportgraphics( ...
        figSchemaball, ...
        fullfile(outputDir,sprintf( ...
            'Figure_3A_conditioning_%s_TEST_vs_PRE_Schemaball.png', ...
            analysisName)), ...
        'Resolution',300,'BackgroundColor','white' ...
    );
    ...
    filePrefix = sprintf( ...
        'Figure3_conditioning_%s_TEST_vs_PRE', ...
        analysisName ...
    );
    ...
    writetable( ...
        metadata, ...
        fullfile(outputDir,sprintf( ...
            'AnalysisMetadata_Figure3_conditioning_%s.csv', ...
            analysisName)) ...
    );
