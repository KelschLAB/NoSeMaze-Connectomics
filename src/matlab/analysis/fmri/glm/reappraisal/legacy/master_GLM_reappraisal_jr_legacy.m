...
regressorsSuffix_sel{1} = '_v22.mat';
...
%     HRF_onset = 'hrf_philipplebhardt';
    ...
    epiPrefix = 'wave_10cons_med1000_msk_s4_wrst_a1_u_despiked_del5_';
    ...
    if 1==1
        ...
        for subj = 1:length(subjects)
            ...
            if contains(epiPrefix,'wave')
                ...
                Pfuncall = spm_select('ExtFPlist',['/zi/flstorage/group_entwbio/data/Jonathan/' fdir(find_ICON:end) filesep 'wavelet'],['^' epiPrefix fname epiSuffix '.nii'],[1:2500]);
