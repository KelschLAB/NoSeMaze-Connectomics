function varargout=notBoxPlot_modified(y,x,varargin)
% notBoxPlot - Doesn't plot box plots!
%
% function notBoxPlot_modified(y,x,'Param1',val1,'Param2',val2,...)
%
%
% Purpose
...
if isvector(y) && isvector(x) && length(x)>1
    ...
    for ii=1:length(u)
        ...
        h(ii)=notBoxPlot_modified(y(f),u(ii),varargin{:},'manualCI',thisCI); %recursive call
    end
