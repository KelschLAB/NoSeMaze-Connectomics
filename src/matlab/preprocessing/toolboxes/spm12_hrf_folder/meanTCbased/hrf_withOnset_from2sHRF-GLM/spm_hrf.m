...
%--------------------------------------------------------------------------
% p   = [6 16 1 1 6 0 32]; % canonical 
% p   = [3 10 1 1 6 0 16]; %randomly chosen by CC
p = [2.25679360238910 6.90190523528124 1.07375527214818 1.07375527214818 6.92161401561498 0.811191450530769 32]; %mice, from /home/jonathan.reinwald/ICON_HRF/04-analyses/03-HRF_estimation/meanTCbased/withOnset_from2sHRF-GLM/hrf_info.mat
