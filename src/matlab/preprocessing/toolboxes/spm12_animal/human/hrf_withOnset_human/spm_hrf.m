...
%--------------------------------------------------------------------------
% p   = [6 16 0.5 0.5 6 2.5 32]; % canonical 
p   = [3.0000    6.0000    0.5000    0.5000    6.0000    2.5000   32.0000]; 
% p   = [3 10 1 1 6 0 16]; %randomly chosen by CC
% p = [2 6 1 1 7 0 16]; %mice, definded by Philipp Lebhardt for his hippocampus study  
